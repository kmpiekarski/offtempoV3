...
function jtd_insertjs_front() {
	...
	wp_enqueue_script( 'jquery.anythingslider', JTD_INSERTJS . '/jquery.anythingslider.min.js', array( 'jquery' ), '1.7.12' );
	
	
	// If video is selected, load the video extension
	if ( $video !== 'false' ) {
	
		wp_enqueue_script( 'jquery.anythingslider.video', JTD_INSERTJS . '/jquery.anythingslider.video.min.js', array( 'jquery' ), '1.7.12' );
	...
	if ( $fade !== 'false' ) {
		...
		wp_enqueue_script( 'jquery.anythingslider.fx', JTD_INSERTJS . '/jquery.anythingslider.fx.min.js', array( 'jquery' ), '1.5.7' );
...
function jtd_insertcss_front() {
	...
	wp_register_style( 'anythingslider-theme', JTD_INSERTCSS . '/theme-' . $theme . '.css', '', '1.7.12' );
