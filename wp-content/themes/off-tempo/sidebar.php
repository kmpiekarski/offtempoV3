<div id="sidebar">
    ...
    <hr />
            ...
            <!--<a href="http://www.offtempo.com/category/live/" style="border:none"><img src="<?php //echo get_option('home'); ?>/wp-content/themes/off-tempo/images/recent_recordings.png" width="280px" alt="" style="margin-left:10px;" /></a>-->
    <div id="record-reviews"><!--RECENT RECORDINGS SECTION-->
    	
        
            <?php //query_posts("cat=5,-4,&paged=$page&posts_per_page=12"); $i = 1; ?><!--Changed to not show podcast if it's also a featured article-->
